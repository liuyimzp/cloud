...
public class AppConfigVo extends BaseVo {
    private static final long serialVersionUID = -32313432230260737L;
    ...
    public AppConfigVo(Long appId, Long appImageId, Double minCPU, Double maxCPU, Double minMemory, Double maxMemory, String startCommand, String runCommand, String stopCommand, Integer appCheckTime, Integer appCheckOvertime, String appCheckType, String appCheckCommand, Integer bizCheckTime, Integer bizCheckOvertime, String bizCheckType, String bizCheckCommand, String appImagePath) {
        this.appId = appId;
