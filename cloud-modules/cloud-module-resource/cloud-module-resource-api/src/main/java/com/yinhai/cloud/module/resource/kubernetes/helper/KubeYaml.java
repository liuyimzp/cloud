 ...
 */
package com.yinhai.cloud.module.resource.kubernetes.helper;
...
public class KubeYaml {
  ...
  private static void initModelMap() throws IOException {
    ...
    ClassPath cp = ClassPath.from(KubeYaml.class.getClassLoader());
  ...
  public static Object load(File f) throws IOException {
    return load(new InputStreamReader(new FileInputStream(f), "UTF-8"));
  }
  ...
  public static Object load(Reader reader) throws IOException {
    Map<String, Object> data = (Map<String, Object>) getSnakeYaml().load(reader);
  ...
  public static <T> T loadAs(File f, Class<T> clazz) throws IOException {
    return getSnakeYaml().loadAs(new InputStreamReader(new FileInputStream(f), "UTF-8"), clazz);
  }
  ...
  public static List<Object> loadAll(File f) throws IOException {
    return loadAll(new InputStreamReader(new FileInputStream(f), "UTF-8"));
  }
  ...
  public static class CustomRepresenter extends Representer {
     ...
     * a KubeYaml object in Kubernetes.
     */
    ...
    protected NodeTuple representJavaBeanProperty(
      ...
      // returning null for a null property value means we won't output it in the KubeYaml
