 ...
 */
public class AppendStepLogHandler implements SSHExecRunningHandler {
    private static final String SHELL_RUNNING_LOG_PREFIX = "RunningLog:";
    private final static Logger logger = LoggerFactory.getLogger(AppendStepLogHandler.class);
    ...
    public AppendStepLogHandler(NodeBasicInfoVo currentNode, Integer currentStepOrder) {
